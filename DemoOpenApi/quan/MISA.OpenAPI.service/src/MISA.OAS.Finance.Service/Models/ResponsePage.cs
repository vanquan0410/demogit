...
{ 
    ...
    public partial class ResponsePage : IEquatable<ResponsePage>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CountPage: ").Append(CountPage).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ResponsePage)obj);
        }
        ...
        public bool Equals(ResponsePage other)
        {
            ...
            return 
                (
                    ...
                    CountPage.Equals(other.CountPage)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CountPage.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ResponsePage left, ResponsePage right)
        {
