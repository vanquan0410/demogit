...
namespace MISA.OAS.OpenApi.SDK.Model
{
    ...
    public partial class Employee :  IEquatable<Employee>, IValidatableObject
    {
        ...
        public Employee(Guid employeeId = default(Guid), string employeeCode = default(string), string employeeName = default(string), GenderEnum? gender = default(GenderEnum?))
        {
